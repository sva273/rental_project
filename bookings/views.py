...
class BookingViewSet(viewsets.ModelViewSet):
    ...
    swagger_docs = {
        "list": swagger_auto_schema(
            ...
            responses={
                200: openapi.Response(
                    description="OK", schema=BookingSerializer(many=True)
                )
            },
        ),
        "create": swagger_auto_schema(
            ...
            responses={
                201: openapi.Response(description="Created", schema=BookingSerializer())
            },
        ),
        "retrieve": swagger_auto_schema(
            operation_summary="Retrieve Booking",
            responses={
                200: openapi.Response(description="OK", schema=BookingSerializer())
            },
        ),
        "update": swagger_auto_schema(
            ...
            request_body=BookingSerializer,
            responses={
                200: openapi.Response(description="Updated", schema=BookingSerializer())
            },
        ),
    ...
    def confirm(self, request, booking):
        ...
        if booking.status != BookingStatusChoices.PENDING:
            return Response(
                {"detail": "This booking has already been processed."},
