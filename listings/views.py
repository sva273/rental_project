    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter('search', openapi.IN_QUERY,
                              description="Search by title, description, city, country", type=openapi.TYPE_STRING),
            ...
            openapi.Parameter('city', openapi.IN_QUERY,
                              description="City", type=openapi.TYPE_STRING),
            openapi.Parameter('country', openapi.IN_QUERY,
                              description="Country", type=openapi.TYPE_STRING),
            openapi.Parameter('property_type', openapi.IN_QUERY,
